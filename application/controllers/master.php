...
class Master extends CI_Controller {
	...
	public function index()
	{
		...
		$golongan = $this->core_model->getAllData('m_golongan')->result();
		$lembaga = $this->core_model->getAllData('m_lembaga')->result();
		$status = $this->core_model->getAllData('m_status')->result();
